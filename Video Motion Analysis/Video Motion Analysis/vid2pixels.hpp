...
Return type is unsigned char *, and follows the pixel format [R,G,B], left to right, top to bottom
...
[255,0,0,0,255,0,0,0,255,255,255,255] = [255,0,0,    0,255,0,    0,0,255,    255,255,255] (spaced added for clarity, but its just a 1D array of unsigned chars)
...
//Returns relevant info about video, in the order: { width, height, framerate }
